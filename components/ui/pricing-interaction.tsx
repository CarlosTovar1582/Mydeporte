...
export function PricingInteraction ({
  ...
  return (
    <div className='flex items-center justify-center'>
      <div className="border-2 border-blue-600  rounded-[32px] p-3 shadow-md max-w-sm  w-full flex flex-col items-center  gap-3  bg-white">
        ...
        <div className="w-full relative flex flex-col items-center justify-center gap-3">
          ...
          >
            <div className="flex flex-col items-start">
              <p className="font-semibold text-xl text-gray-950">Free (Anuncios hasta s/.100)</p>
              <p className="text-slate-500 text-md">
                <span className="text-black font-medium">$0.00</span>/solo para anuncios
              </p>
            </div>
            <div
